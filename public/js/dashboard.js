...
const totalExpenses10 = expense10.reduce((total, expense) => total + expense, 0);
const totalExpenses11 = expense11.reduce((total, expense) => total + expense, 0);
const totalExpenses12 = expense12.reduce((total, expense) => total + expense, 0);
...
if (budget1 > 0) {
  ...
  budgetStatus = "Zero";
    ...
    // ===================================================================================================================================
// import { findTotal } from './monthOfIncome.j';
    
    
//       const totalAmount = await findTotal(findTotal);
    ...
    const chart = Highcharts.chart('high-container', {
      ...
      series: [{
          type: 'column',
          name: 'income',
          data: [totalIncome1,totalIncome2,totalIncome3, totalIncome4,totalIncome5,totalIncome6, totalIncome7, totalIncome8, totalIncome9,totalIncome10,totalIncome11,totalIncome12]
      }, {
          type: 'column',
          name: 'expenses',
          data: [totalExpenses1,totalExpenses2,totalExpenses3,totalExpenses4,totalExpenses5,totalExpenses6,totalExpenses7,totalExpenses8, totalExpenses9,totalExpenses10,totalExpenses11,totalExpenses12]
      }, {
          type: 'column',
          name: 'saving',
          data: [budget1,budget2,budget3,budget4,budget5,budget6, budget7,budget8, budget9,budget10,budget11,budget12]
      }, {
          type: 'spline',
          name: 'Average',
          data: [averageIncome1,averageExpenses2,averageExpenses3,averageExpenses4,averageExpenses5,averageExpenses6,averageExpenses7,averageExpenses8,averageExpenses9,averageExpenses10,averageExpenses11,averageExpenses12],
          marker: {
              lineWidth: 2,
